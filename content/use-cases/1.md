...
where m is the mass of the pole in lbs. The mass m of the pole can be calculated using the density \roe of the material, e.g., \\(35 lb/ft^3\\), such that \((m = (D/2/12)^2 H \roe =0.001736 \pi D^2 H \roe \\). 
...
$$MPT= 0.125\roe \pi H^2\[1/6(D_0+D_1)^2+1/3D_1^2]sin\alpha$$
